...
namespace GeneralUtilities
{
	public class ErrorControl
	{
		...
		public void EvaluateResult(int result, string errorText = "", int errorReason = 0, int key = 0, string tableName = _EMPTY)
		{
			EvaluateResult(0, result, errorText, errorReason, key, tableName);
		}
		...
		#endregion
		public string YieldError(int userId = 0)
		{
			// output
		...
		public void InitializeErrorhandling(int userId = 0)
		{
			DeleteErrorMessages(userId);
			DeleteWarningMessages(userId);
		}
		public string YieldWarning(int userId = 0)
		{
			string returnMessage = string.Empty;
		...
		/// </summary>
		/// <returns>The error message by identifier.</returns>
		/// <param name="id">Identifier.</param>
		public string GetErrorMessageById(int id)
		{
			return GetErrorMessageById(0, id);
		}
		...
		public List<string> GetErrorMessages(int userId = 0)
		{
		...
		public List<string> GetWarningMessages(int userId = 0)
		{
			List<string> messages = new List<string>();
		...
		private void CompletionMessage(int rowsOK, int rowsER)
		{
			CompletionMessage(0, rowsOK, rowsER);
		}
